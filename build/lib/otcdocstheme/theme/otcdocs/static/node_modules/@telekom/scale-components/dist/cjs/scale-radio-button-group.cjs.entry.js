...
const RadioButtonGroup = class {
  ...
  render() {
    return (index.h("form", null, index.h("fieldset", { class: "radio-button-group" }, index.h("legend", { class: "radio-button-group__title" }, index.h("label", { class: "radio-button-group__title-label", "aria-label": this.label }, this.label), this.helperText ? (index.h("div", { role: "text", class: this.getCssClassMap(), "aria-label": this.helperText }, this.helperText)) : null), index.h("div", { class: "radio-button-group__container" }, index.h("slot", null)))));
  }
  getCssClassMap() {
