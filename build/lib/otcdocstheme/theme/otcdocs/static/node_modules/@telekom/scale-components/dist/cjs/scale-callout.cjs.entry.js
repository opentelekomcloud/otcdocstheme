...
const Callout = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("style", null, this.displayStyle()), index.h("div", { part: this.getBasePartMap(), class: this.getCssClassMap() }, index.h("div", { part: "inner", class: "callout__inner" }, index.h("div", { class: "callout__prefix" }, index.h("slot", { name: "prefix" })), index.h("div", { class: "callout__text" }, index.h("span", null, index.h("slot", null)), this.asterisk && (index.h("sup", { title: this.asterisk, class: "callout__sup" }, "*")))))));
  }
  getBasePartMap() {
  ...
  getCssOrBasePartMap(mode) {
    ...
    return index$1.classnames(name, this.variant && `${prefix}color-${this.variant}`, this.size && `${prefix}size-${this.size}`, this.asterisk && `${prefix}asterisk`);
  }
