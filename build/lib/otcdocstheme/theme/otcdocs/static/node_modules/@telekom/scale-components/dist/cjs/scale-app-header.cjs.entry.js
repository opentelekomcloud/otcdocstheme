...
const Header = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("header", { class: "header__container" }, index.h("div", { class: this.getCssClassMap() }, index.h("div", { class: "header__brand" }, index.h("span", { class: "header__brand-before" }), index.h("span", { class: "header__brand-after" }), index.h("div", { class: "header__brand-content" }, index.h("div", { class: "header__brand-branding" }, this.hasSlotLogo ? (index.h("slot", { name: "logo" })) : (index.h("app-logo", { claim: true, claimLang: this.claimLang, href: this.logoHref, logoTitle: this.logoTitle, onClick: this.logoClick }))), index.h("div", { class: "header__brand-sector" }, this.menuSector()), index.h("div", { class: "header__brand-meta" }, this.menuAddon()))), index.h("nav", { class: "header__nav", "aria-label": "top" }, index.h("span", { class: "header__nav-before" }), index.h("span", { class: "header__nav-after" }), index.h("div", { class: "header__nav-content" }, index.h("div", { class: "header__nav-logo" }, index.h("app-logo", { color: "#e20074", href: this.logoHref, logoTitle: this.logoTitle, onClick: this.logoClick, focusable: this.scrolled })), index.h("div", { class: "header__nav-menu-wrapper" }, index.h("div", { class: "header__nav-menu-main" }, this.menuMain()), index.h("div", { class: "header__nav-menu-icon" }, this.menuIcon())))), index.h("nav", { class: `header__nav__mobile-menu${this.mobileMenu ? ' header__nav__mobile-menu--opened' : ''}`, "aria-label": "main" }, this.hasSlotMenuMobile ? (index.h("slot", { name: "menu-mobile" })) : (index.h("div", null, index.h("app-navigation-sector-mobile", { navigation: readData(this.sectorNavigation), activeSectorId: this.activeSectorId, hide: () => {
  ...
  getCssClassMap() {
    return index$1.classnames('header', this.scrolled && 'header--sticky', (this.visibleMegaMenu || this.mobileMenu || this.userMenuMobile) &&
      'menu--open');
  }
