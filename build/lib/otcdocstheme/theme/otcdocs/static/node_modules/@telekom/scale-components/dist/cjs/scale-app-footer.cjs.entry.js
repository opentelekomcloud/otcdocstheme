...
const AppFooter = class {
  ...
  render() {
    return (index.h(index.Host, null, this.styles && index.h("style", null, this.styles), index.h("div", { class: this.getCssClassMap() }, index.h("div", { class: "footer-mask" }), index.h("footer", { class: "footer" }, index.h("div", { class: "footer-content" }, index.h("div", { class: "footer-branding" }, this.hasSlotLogo ? (index.h("slot", { name: "logo" })) : (index.h("app-logo", { claim: true, claimLang: this.claimLang }))), index.h("div", { class: "footer-copyright" }, this.copyright), index.h("nav", { "aria-label": "bottom", class: "footer-navigation" }, this.hasSlotNavigation ? (index.h("slot", { name: "navigation" })) : (index.h("ul", null, readData(this.footerNavigation).map((item) => (index.h("li", { class: "footer-navigation__item" }, index.h("a", { class: "footer-navigation__item-link", href: item.href || 'javascript:void(0);', onClick: (event) => {
