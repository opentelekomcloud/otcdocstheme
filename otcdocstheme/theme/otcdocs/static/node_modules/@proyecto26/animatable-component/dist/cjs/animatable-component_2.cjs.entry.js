...
function createAnimation(element, context) {
  const newKeyFrames = context.keyFrames
    || (context.animation && index.KEYFRAMES[context.animation])
...
const AnimatableComponent = class {
  constructor(hostRef) {
    ...
    this.onStart = index$1.createEvent(this, "start", 3);
    this.onFinish = index$1.createEvent(this, "finish", 3);
    this.onCancel = index$1.createEvent(this, "cancel", 3);
    /**
  ...
  animationDidChangeHandler(animation) {
    this.keyFrames = index.getKeyFramesByAnimation(animation);
  }
  /**
...
const Cube = class {
  ...
  render() {
    return (index$1.h(index$1.Host, null, index$1.h("div", null, index$1.h("div", { class: "front face" }, index$1.h("slot", { name: 'front-face' })), index$1.h("div", { class: "back face" }, index$1.h("slot", { name: 'back-face' })), index$1.h("div", { class: "right face" }, index$1.h("slot", { name: 'right-face' })), index$1.h("div", { class: "left face" }, index$1.h("slot", { name: 'left-face' })), index$1.h("div", { class: "top face" }, index$1.h("slot", { name: 'top-face' })), index$1.h("div", { class: "bottom face" }, index$1.h("slot", { name: 'bottom-face' })), index$1.h("slot", null))));
  }
  get el() { return index$1.getElement(this); }
  static get watchers() { return {
    "animation": ["animationDidChangeHandler"],
