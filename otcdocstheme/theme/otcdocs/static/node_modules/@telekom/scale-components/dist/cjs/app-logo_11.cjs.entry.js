...
const renderIcon = require('./render-icon-92acfc13.js');
...
const AppNavigationUserMenu = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("div", { class: "app-navigation-user-menu" }, this.navigation.map((item) => {
      if (item.type === 'divider') {
        return (index.h("hr", { class: "app-navigation-user-menu__divider", part: "rule-horizontal" }));
      }
      if (item.type === 'userInfo') {
        return (index.h("div", { class: "app-navigation-user-menu__user-info" }, index.h("div", { class: "app-navigation-user-menu__user-info--name scl-font-variant-heading-4" }, item.name), index.h("div", { class: "app-navigation-user-menu__user-info--email" }, item.email)));
      }
      if (item.type === 'item') {
        return (index.h("a", { href: item.href || 'javascript:void(0);', tabindex: 0, class: "app-navigation-user-menu__item", onClick: (e) => {
            if (item.onClick) {
              item.onClick(e);
            }
            this.hide();
      ...
      if (item.type === 'button') {
        return (index.h("scale-button", { class: "app-navigation-user-menu__button", onClick: (e) => {
            if (item.onClick) {
              item.onClick(e);
            }
            this.hide();
...
const NavMain = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("li", { class: this.getCssClassMap() }, index.h("a", { class: "main-navigation__item-link", href: this.href, "aria-current": this.active || this.isActive ? 'true' : 'false', "aria-haspopup": this.hasPopup ? 'true' : 'false', onClick: this.clickLink }, index.h("span", { class: "main-navigation__item-link-text" }, this.name), (this.active || this.isActive) && (index.h("span", { class: "sr-only" }, "active"))), index.h("slot", null))));
  }
  getCssClassMap() {
...
const NotificationBadge = class {
  ...
  getRender() {
    return (index.h("div", { class: this.getCssClassMap() }, index.h("a", { class: "notification-badge__wrapper" }, index.h("slot", null), index.h("span", { class: "notification-badge__circle" }, this.getBadgeLabel())), index.h("slot", { name: "after-badge" })));
  }
  render() {
