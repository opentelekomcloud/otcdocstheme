...
const LoadingSpinner = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("div", { part: this.getBasePartMap(), class: this.getCssClassMap() }, index.h("div", { part: "container", class: "spinner__container" }, index.h("svg", { class: "spinner__circle", viewBox: "0 0 50 50", "aria-hidden": "true" }, index.h("circle", { class: "path", cx: "25", cy: "25", r: "20", fill: "none", "stroke-width": "4" })), index.h("svg", { class: "spinner__circle-background", viewBox: "0 0 50 50", "aria-hidden": "true" }, index.h("circle", { class: "path", cx: "25", cy: "25", r: "20", fill: "none", "stroke-width": "4" }))), index.h("div", { class: "sr-only", "aria-live": "polite", id: `spinner-label-${i}` }, this.text || 'Loading'), index.h("div", { part: "text", class: "spinner__text", "aria-hidden": "true" }, this.text))));
  }
  getBasePartMap() {
