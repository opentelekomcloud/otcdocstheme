...
const Tooltip = class {
  ...
  render() {
    return (index.h(index.Host, { class: "host-container", onKeyDown: this.handleKeyDown, onMouseOver: this.handleMouseOver, onMouseOut: this.handleMouseOut }, index.h("div", { class: "slot-container" }, index.h("slot", { onSlotchange: this.handleSlotChange })), !this.disabled && (index.h("div", { class: "tooltip-positioner", ref: (el) => (this.tooltipPositioner = el), onMouseOver: this.handleTooltipMouseOver }, index.h("div", { class: {
        tooltip: true,
        'tooltip--open': this.open,
      }, onMouseOver: this.handleTooltipMouseOver, part: "base", ref: (el) => (this.tooltip = el), id: this.componentId, role: "tooltip", "aria-hidden": this.open ? 'false' : 'true' }, index.h("div", { class: "content-wrapper", tabindex: 0 }, index.h("slot", { name: "content" }, this.content)))))));
  }
