...
const ToggleButton = class {
  ...
  render() {
    return (index.h(index.Host, null, this.styles && index.h("style", null, this.styles), index.h("button", { class: this.getCssClassMap(), id: this.toggleButtonId, onClick: this.handleClick, disabled: this.disabled, type: "button", "aria-label": this.ariaLabel, "aria-pressed": this.selected, part: this.getBasePartMap(), "aria-description": this.getAriaDescriptionTranslation() }, index.h("slot", null))));
  }
  getBasePartMap() {
  ...
  getCssOrBasePartMap(mode) {
    ...
    return index$1.classnames('toggle-button', this.size && `${prefix}${this.size}`, this.background &&
...
exports.scale_toggle_button = ToggleButton;
