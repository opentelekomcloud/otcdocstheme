...
const DataGrid = class {
  ...
  renderSettingsMenu() {
    return (index.h("scale-menu-flyout", { class: `${name}__settings-menu` }, index.h("scale-button", { slot: "trigger", variant: "secondary", "icon-only": true, "data-sortable": this.isSortable }, index.h("scale-icon-service-settings", { accessibilityTitle: "Table options" })), index.h("scale-menu-flyout-list", null, this.isSortable && (index.h("scale-menu-flyout-item", { id: "sortBy", onClick: this.handleMenuListClick }, index.h("scale-icon-action-sort", { slot: "prefix" }), "Sort By", index.h("scale-menu-flyout-list", { slot: "sublist", id: "sortByList" }, this.fields.map(({ label, type, sortable, sortDirection = 'none' }, columnIndex) => {
      if (!sortable) {
        return '';
      }
    ...
    })))), index.h("scale-menu-flyout-item", { id: "toggleVisibility", onClick: this.handleMenuListClick }, index.h("scale-icon-action-hide-password", { slot: "prefix" }), "Toggle Visibility", index.h("scale-menu-flyout-list", { slot: "sublist", "close-on-select": "false", id: "toggleVisibilityList" }, this.fields.map(({ label, type, visible = CELL_TYPES[type].defaults.visible !== undefined
