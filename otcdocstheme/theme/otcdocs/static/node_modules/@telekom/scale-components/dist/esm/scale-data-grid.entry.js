import { h, r as registerInstance, c as createEvent, H as Host, g as getElement } from './index-6d2d4f7b.js';
...
const DataGrid = class {
  ...
  renderSettingsMenu() {
    return (h("scale-menu-flyout", { class: `${name}__settings-menu` }, h("scale-button", { slot: "trigger", variant: "secondary", "icon-only": true, "data-sortable": this.isSortable }, h("scale-icon-service-settings", { accessibilityTitle: "Table options" })), h("scale-menu-flyout-list", null, this.isSortable && (h("scale-menu-flyout-item", null, h("scale-icon-action-sort", { slot: "prefix" }), "Sort By", h("scale-menu-flyout-list", { slot: "sublist" }, this.fields.map(({ label, type, sortable, sortDirection = 'none' }, columnIndex) => {
      if (!sortable) {
        return '';
      }
