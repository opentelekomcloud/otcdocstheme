import { N as NAMESPACE, r as registerInstance, c as createEvent$1, h as h$1, H as Host$1, g as getElement$1 } from './index-6d2d4f7b.js';
import { s as statusNote } from './status-note-d227f142.js';
import { c as classnames } from './index-713f92a5.js';
import { e as emitEvent$1 } from './utils-af738b80.js';
...
const DatePicker = class {
  ...
  render() {
    return (h$1(Host$1, null, this.styles && h$1("style", null, this.styles), h$1("div", { class: classnames('scale-date-picker', this.status && `scale-date-picker--status-${this.status}`, this.invalid && `scale-date-picker--status-error`, this.hasFocus && 'scale-date-picker--focus', this.disabled && 'scale-date-picker--disabled', this.size && `scale-date-picker--size-${this.size}`, this.hasValue && 'animated') }, h$1("label", { class: "date-picker__label", htmlFor: this.identifier }, this.label), h$1("duet-date-picker", { onDuetChange: (e) => {
        ...
        this.hasFocus = false;
      }, name: this.name, identifier: this.identifier, role: this.role, direction: this.direction, required: this.required, min: this.min, max: this.max, firstDayOfWeek: this.firstDayOfWeek, localization: this.localization, dateAdapter: this.dateAdapter, disabled: this.disabled, value: this.value, ref: (element) => (this.duetInput = element) }), !!this.helperText && (h$1("div", { class: "date-picker__meta", id: this.helperTextId, "aria-live": "polite", "aria-relevant": "additions removals" }, h$1("div", { class: "date-picker__helper-text" }, this.helperText))))));
  }
