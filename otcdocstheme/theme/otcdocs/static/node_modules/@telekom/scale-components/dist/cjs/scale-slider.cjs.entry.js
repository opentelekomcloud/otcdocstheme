...
const Slider = class {
  constructor(hostRef) {
    ...
    this.onDragEnd = () => {
      this.dragging = false;
      utils.emitEvent(this, 'scaleChange', this.value);
      this.removeGlobalListeners();
    };
    this.setValue = (nextValue) => {
      this.value = this.clamp(nextValue);
      utils.emitEvent(this, 'scaleInput', this.value);
    };
    this.setPosition = () => {
      if (!this.value) {
        this.position = 0;
  ...
  render() {
    return (index.h(index.Host, null, this.styles && index.h("style", null, this.styles), index.h("div", { part: this.getBasePartMap(), class: this.getCssClassMap() }, !!this.label && (index.h("label", { part: "label", class: "slider__label", id: `${this.sliderId}-label`, htmlFor: this.sliderId }, this.label)), index.h("div", { part: "track-wrapper", class: "slider__track-wrapper" }, index.h("div", { part: "track", class: "slider__track", ref: (el) => (this.sliderTrack = el) }, index.h("div", { part: "bar", class: "slider__bar", style: {
        width: `${this.position}%`,
  ...
  getCssOrBasePartMap(mode) {
    ...
    return index$1.classnames(component, this.disabled && `${prefix}disabled`, this.trackSmall && `${prefix}track-small`, this.thumbLarge && `${prefix}thumb-large`);
  }
