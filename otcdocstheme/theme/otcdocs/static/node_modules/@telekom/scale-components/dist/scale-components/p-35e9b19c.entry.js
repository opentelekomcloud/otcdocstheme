import{h as t,r as e,c as i,H as s,g as l}from"./p-5a5f5509.js";import{c as o}from"./p-c608c6dc.js";import{e as a}from"./p-9f14ed82.js";const n={checkbox:{defaults:{sortBy:"number"},getLongestContent:({rows:t,columnIndex:e})=>t[0][e],render:({field:e,content:i,component:s,rowIndex:l,columnIndex:o})=>{const{style:a="checkbox",editable:n=!1,label:r}=e,d={checked:i,disabled:!n,label:r};switch(n&&(d.onScaleChange=t=>{const{value:e}=t.detail;s.rows[l][o]=e,s.triggerEditEvent(e,l,o)}),a){case"switch":return t("scale-switch",Object.assign({},d));default:return t("scale-checkbox",Object.assign({},d))}}},date:{defaults:{sortBy:"text"},render:({content:e,isAutoWidthCheck:i})=>{let s=e;return i&&(s=s.replace(/[0-9]/g,"8")),t("p",{class:"scl-body"},s)}},graph:{defaults:{sortBy:"number"},render:({field:e,content:i})=>{const{style:s="progress",min:l=0,max:o=100}=e,a=(i-l)/(o-l)*100;switch(s){case"bar":return t("div",{class:"tbody__bar-cell"},t("scale-progress-bar",{"aria-hidden":"true",percentage:a,mute:!0,style:{maxWidth:"200px"},styles:".progress-bar__outer {\n                min-width: 50px;\n                max-width: 200px;\n              }\n              .progress-bar__inner {\n                background: var(--scl-color-grey-80) !important;\n              }\n              "}),t("p",{class:"scl-body"},i));default:return t("scale-progress-bar",{percentage:a,showStatus:!0,mute:!0,styles:".progress-bar__outer {\n              min-width: 50px;\n              max-width: 200px;\n            }\n            .progress-bar__inner {\n                background: var(--scl-color-blue-60) !important;\n              }\n            "})}}},html:{defaults:{},getLongestContent:({rows:t,columnIndex:e})=>t[0][e],render:({content:e,component:i})=>t("scale-button",{variant:"secondary",size:"small","icon-only":!0,"aria-label":`Activate to ${e.isExpanded?"collapse":"expand"} content`,onClick:()=>{e.isExpanded=!e.isExpanded,i.forceRender++}},t(e.isExpanded?"scale-icon-navigation-collapse-up":"scale-icon-navigation-collapse-down",{size:14}))},link:{defaults:{sortBy:"text"},render:({content:e})=>{const i=e.replace(/^https?\:\/\//i,"");return t("scale-link",{href:e,target:"_blank"},i)}},number:{defaults:{textAlign:"right",sortBy:"number"},render:({field:e,content:i,component:s,rowIndex:l,columnIndex:o,isAutoWidthCheck:a})=>{const{precision:n=1/0,decimalSymbol:r=".",groupSymbol:d="",prefix:c="",suffix:h="",editable:b=!1,label:g}=e;if(a&&b)return t("p",{class:"scl-body",style:{paddingRight:"26px"}},i);const p=`0.${(String(i).split(".")[1]||"").split("").map((()=>"0"))}`.replace(/,/g,"");if(b){const e={type:"number",size:"small",step:p.slice(0,p.length-1)+"1",value:String(i),styles:".text-field__control {\n          text-align: right !important;\n        }",label:g,onScaleChange:({detail:t})=>{const{value:e}=t;s.rows[l][o]=e,s.triggerEditEvent(e,l,o)}};return t("scale-text-field",Object.assign({},e))}{let e=i;if(a&&(e=Number(e.toString().replace(/[0-9]/g,"8"))),e=n<100?Number(e).toFixed(n):e.toString(),d||"."!==r){const t=e.split(".");d&&(t[0]=t[0].replace(/\B(?=(\d{3})+(?!\d))/g,d)),e=t.join(r)}return(c||h)&&(e=c+e+h),t("p",{class:"scl-body",style:{textAlign:"right"}},e)}}},select:{defaults:{sortBy:"text"},render:({field:e,content:i,component:s,rowIndex:l,columnIndex:o,isAutoWidthCheck:a})=>{const{options:n,editable:r=!1,label:d}=e;if(a)return t("p",{class:"scl-body",style:{paddingRight:"56px"}},i);const c={disabled:!r,value:i,label:d};return r&&(c.onScaleChange=({detail:t})=>{const{value:e}=t;s.rows[l][o]=e,s.triggerEditEvent(e,l,o)}),t("scale-dropdown",Object.assign({size:"small"},c),n.map((e=>t("option",{value:e,selected:e===i},e))))}},tags:{defaults:{sortBy:"text"},render:({content:e})=>{const i=e.split(",").map((t=>t.trim()));return t("ul",{class:"tbody__tag-list"},i.map((e=>t("li",null,t("scale-tag",{size:"small"},e)))))}},text:{defaults:{sortBy:"text"},render:({field:e,content:i,component:s,rowIndex:l,columnIndex:o,isAutoWidthCheck:a})=>{const{variant:n="body",editable:r=!1,iconPrefix:d,iconSuffix:c,label:h}=e;if(a&&r)return t("p",{class:"scl-body",style:{paddingRight:"26px"}},i);if(r){return t("scale-text-field",Object.assign({},{type:"text",size:"small",value:i,label:h,onScaleChange:({detail:t})=>{const{value:e}=t;s.rows[l][o]=e,s.triggerEditEvent(e,l,o)}}))}{let e=i;return a&&(e+="w"),t("div",{class:"tbody__text-cell"},d&&t("span",{class:"tbody__text-cell-prefix"},t(`scale-icon-${d}`)),t("p",{class:`scl-${n}`},e),c&&t("span",{class:"tbody__text-cell-suffix"},t(`scale-icon-${c}`)))}}},actions:{defaults:{},getLongestContent:({rows:t,columnIndex:e})=>t[0][e],render:({content:e})=>t("div",{class:"tbody__actions"},e.map((e=>{const{label:i}=e,s=function(t,e){var i={};for(var s in t)Object.prototype.hasOwnProperty.call(t,s)&&e.indexOf(s)<0&&(i[s]=t[s]);if(null!=t&&"function"==typeof Object.getOwnPropertySymbols){var l=0;for(s=Object.getOwnPropertySymbols(t);l<s.length;l++)e.indexOf(s[l])<0&&Object.prototype.propertyIsEnumerable.call(t,s[l])&&(i[s[l]]=t[s[l]])}return i}(e,["label"]);return"object"==typeof i&&"__html"in i?t("scale-button",Object.assign({innerHTML:i.__html},s)):t("scale-button",Object.assign({},s),i)})))}},r={maxWidth:1/0,minWidth:20,resizable:!0,sortable:!1,sortBy:"text",textAlign:"left",visible:!0,width:"auto"};
/**
 * @license
